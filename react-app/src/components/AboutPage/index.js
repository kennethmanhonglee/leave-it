        ...
        <div className={styles.about_us}>
          ...
          <div className={styles.about}>
            <p>
              ...
              . The calculations for the resting energy requirements and daily caloric needs are done based on the
              {' '}
              <a
            ...
            <p>
              According to above link, &quot;Individual pet needs can vary by as much as 50% from calculated values.&quot; This
              means that the daily calculated calories for pets are to be used as a reference. The actual amount should
              be adjusted up or down as needed to maintain a healthy body condition score.
            </p>
            <p>This app is developed by Kenneth Lee as a capstone project for App Academy.</p>
          </div>
        </div>
      </div>
    </div>
